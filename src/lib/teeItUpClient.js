// Fetches real tee-time inventory from the Mecklenburg County Golf booking
// engine (GolfNow/TeeItUp). This is the same backend the public booking
...
// data/courses.json (currently the two Mecklenburg County courses); expect
// it to need updating if TeeItUp changes their backend.
...
async function fetchTeeTimes(course, date, players) {
